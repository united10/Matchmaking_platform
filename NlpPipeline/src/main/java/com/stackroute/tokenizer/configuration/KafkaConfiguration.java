package com.stackroute.tokenizer.configuration;
...
public class KafkaConfiguration {
 ...
 /*   Used to consume data(as object) from particular kafka topic
    ...
    */
    ...
    @Bean
    public ConsumerFactory<String, Search> userConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String,Search> userKafkaListenerFactory() {
